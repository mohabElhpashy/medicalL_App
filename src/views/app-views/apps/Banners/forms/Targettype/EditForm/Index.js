...
const ProductForm = (props) => {
  ...
  const getSingleCar = useFetchSingle(`serviceProvider/${recordId}`);
  ...
  console.log("consossos",postObject)
// useEffect(()=>{
//   if(isSuccess)
//   {
//     setPostObject({
...
useEffect(()=>{
  if (isSuccess) {
    ...
    setPostObject({
      ...
      category_name_en:singleCar.category_name_en,
      lat:singleCar.lat,
      long:singleCar.long,
      logo:singleCar.logo
          ...
          <PageHeaderAlt className="border-bottom" overlap>
            <div className="container">
              ...
              >
                ...
                <div className="mb-3">
                  <Button className="mr-2" onClick={() => history.push("targetType")}>
                    Discard
                  </Button>
                  <Button
                    type="primary"
