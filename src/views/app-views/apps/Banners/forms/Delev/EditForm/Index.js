...
const ProductForm = (props) => {
  ...
  const getSingleCar = useFetchSingle(`delivery/${recordId}`);
  ...
  console.log("consossos",singleCar)
// useEffect(()=>{
//   if(isSuccess)
//   {
//     setPostObject({
          ...
          <PageHeaderAlt className="border-bottom" overlap>
            <div className="container">
              ...
              >
                ...
                <div className="mb-3">
                  <Button className="mr-2" onClick={() => history.push("Banner")}>
                    Discard
                  </Button>
                  <Button
                    type="primary"
